	...
	public static void main(String[] args)
	{
		...
		while (scanner.hasNextLine())
		{
			...
			else if (action.equalsIgnoreCase("PLAYSONG")) 
			{
				...
				} else { System.out.println(mylibrary.getErrorMessage()); }
			...
			{
				if (mylibrary.printallPlaylists()) {
				} else { System.out.println(mylibrary.getErrorMessage()); }
			}
			// Specify a playlist title (string) 
			...
			else if (action.equalsIgnoreCase("PLAYPL")) 
			{
				...
				if (mylibrary.playPlaylist(title, contentNum)) {
				} else { System.out.println(mylibrary.getErrorMessage()); }
		  ...
		  // see class Library for the method to call
			else if (action.equalsIgnoreCase("ADDTOPL")) 
			{
				...
				if (mylibrary.addContentToPlaylist(type, contentNum, title)) {
				} else { System.out.println(mylibrary.getErrorMessage()); }
			}
		  ...
		  // see class Library for the method to call
			else if (action.equalsIgnoreCase("DELFROMPL")) 
			{
				...
				if (mylibrary.delContentFromPlaylist(contentNum, title)) {
				} else { System.out.println(mylibrary.getErrorMessage()); }
			}
