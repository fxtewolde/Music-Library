...
public class Song extends AudioContent implements Comparable<Song>// implement the Comparable interface
{
	...
	{
		super.printInfo();
		System.out.println("Artist: " + this.artist + " Composer: " + this.composer + " Genre: " + this.genre.toString());
	}
	...
	public void play()
	{
		...
		System.out.println("\n" + super.getAudioFile()); // Simulate playing of the audio file
	...
	public boolean equals(Object other)
	{
		...
		if (otherA.getComposer() == this.getComposer() && otherA.getArtist() == this.getArtist() && super.equals(otherA))
		{
			return true;
		}
