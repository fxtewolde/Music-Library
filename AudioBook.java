...
public class AudioBook extends AudioContent
{
									...
									String author, String narrator, ArrayList<String> chapterTitles, ArrayList<String> chapters)
	{
		...
		super(title, year, id, type, audioFile, length); //Sending information through superclass constructor
		this.author = author;
		this.narrator = narrator;
		this.chapterTitles = new ArrayList<String> (chapterTitles);
		this.chapters = new ArrayList<String> (chapters);
		//initializing the rest of the instance variables
	}
  ...
  // Play the audiobook by setting the audioFile to the current chapter title (from chapterTitles array list) 
	...
	public void play()
	{
		...
		System.out.println("\n" + chapterTitles.get(currentChapter) + ".\n" + chapters.get(currentChapter)); // Simulate playing of the audio file
	...
	public void printTOC()
	{
		for (int i = 0; i < this.chapters.size(); i++) {
			...
			System.out.println(this.chapterTitles.get(i));
			System.out.println();
		}
	}
